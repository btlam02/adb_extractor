...
void main()
{
    float distanceToEdge = length(vertexPosition.xy) - 1.0;
    float distanceToEdgePixels = distanceToEdge * radius / pixelToMeterFactor;
    gl_FragColor = antiAliasedBorder(distanceToEdgePixels, -1.5, -0.5, mainColor, borderColor);
}
